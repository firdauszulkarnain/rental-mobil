...
$id = $_GET['id'];
$sewa = mysqli_query($db, "SELECT * FROM laporan lp JOIN sewa sw ON lp.sewa_id = sw.id_sewa JOIN mobil mb ON sw.mobil_id = mb.id_mobil WHERE id_laporan = $id");
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detail Laporan Sewa Mobil</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-5">
                ...
                <div class="col-lg-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="tanggal_selesai" class="col-sm-4 col-form-label">Tanggal Pinjam</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="tanggal_selesai" value="<?= $sewa['tanggal_selesai'] ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
